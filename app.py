...
def inicializar_bd():
    ...
    # Tabla para almacenar los datos de telemetría de las mascotas
    cursor.execute('''
...
# RUTA API: Recibe los datos del ESP32 o de pruebas PowerShell
...
def recibir_datos():
    ...
    try:
        ...
        print(f"✅ [DB Guardada] Temp: {temperatura}°C | HR: {ritmo_cardiaco} bpm")
